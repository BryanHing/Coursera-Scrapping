...
URLS_FILE = str(BASE_DIR / "xpaths.txt")  # one URL per line
SERVICE_ACCOUNT_JSON = str(BASE_DIR / "n8n-integration-bryan-c9074da0d443.json")
...
DEBUG_OUTPUT_DIR = BASE_DIR / "debug_html"
BATCH_SIZE = 5
